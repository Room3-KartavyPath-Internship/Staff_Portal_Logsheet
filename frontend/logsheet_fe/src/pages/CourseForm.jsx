...
const CourseForm = () => {
  ...
  useEffect(() => {
    ...
    getCourseTypes()
      .then((res) => {
        // Adjust for ApiResponse wrapper
      ...
      getCourseById(id)
        .then((res) => {
          ...
          setCourse({
            ...
            endDate: c.endDate || "",
            batchCycleId: c.batchCycle?.id || "",
            premiseId: c.premise?.id || "",
            courseTypeId: c.courseType?.courseTypeId || "",
          });
        })
  ...
  batchCycle: { id: course.batchCycleId },
  premise: { id: course.premiseId },
  courseType: { id: course.courseTypeId }, // ✅ fix here
};
